...
@Slf4j
public class AdxIndicator implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        try {
            ...
            this.dataHistoryRepository.adxIndicator(Temporality.D);
        } catch (Exception e) {
            throw new TaskletExecutionException("ADX calculation failed");
        }
