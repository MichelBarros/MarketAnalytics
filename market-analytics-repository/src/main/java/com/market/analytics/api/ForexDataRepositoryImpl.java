...
import com.market.analytics.api.exception.ForexDailyPricingException;
...
@Slf4j
@Repository
public class ForexDataRepositoryImpl implements ForexDataRepository {
    ...
    public ForexDataRepositoryImpl(WebClient webClient,
        ...
        return this.webClient
                ...
                .uri(
                        uriBuilder -> uriBuilder
                                ...
                                .path(this.marketAnalyticsConfigProperties.getApis().getBulkData().getForexDaily())
                ...
                .onErrorMap(WebClientResponseException.class, ex -> {
                    ...
                    throw new ForexDailyPricingException();
                });
    }
